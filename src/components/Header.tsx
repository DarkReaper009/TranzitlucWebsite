...
const Header = () => {
  return (
    <div
      className="bg-[#121D50]  w-[100vw] h-24 text-white flex flex-row px-[9rem] sticky top-0 left-0 z-10"
    ...
    >
      ...
      <div className="navigation w-[50%] h-[100%] display flex justify-center items-center">
