      ...
      <div className="flex flex-col h-full w-full gap-11">
        <div className="flex flex-col gap-4 w-full h-[9.5rem]">
          ...
          <p className="text-h2 text-db1 font-h2 leading-[120%]">
            SPRIJINIM AFACEREA DUMNEAVOASTRĂ CU SOLUȚII LOGISTICE PERSONALIZATE
          </p>
        </div>
        <p className="text-b1 text-gr2 font-b1 leading-[140%]">
          ...
          client. <br /> Cu o experiență de peste 16 ani în domeniu și o echipă
          de profesioniști în domeniul transporturilor, ne angajăm să oferim
          servicii de transport impecabile, care să sprijine dezvoltarea
          afacerii dumneavoastră. Suntem o companie de încredere, recunoscută
          pentru seriozitatea și angajamentul nostru față de fiecare proiect.{' '}
          <br /> Ne-am consolidat reputația prin prestarea de servicii în
          sud-estul României, în orașe precum București, Constanța, Ploiești,
          Călărași, Galați, Pitești, Slobozia și Medgidia. În decursul anilor,
          am demonstrat că putem duce la bun sfârșit fiecare transport,
          optimizând costurile și asigurându-ne că oferim cele mai bune soluții
