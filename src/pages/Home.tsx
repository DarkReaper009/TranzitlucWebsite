...
const Home = () => {
  ...
  return (
    <Section
      id="home"
      customPaddings="pt-[6rem] px-[2rem] sm:px-[4rem] lg:px-[6rem]"
    ...
    >
      ...
      />
      <div className="flex flex-col justify-center sm:justify-center 2xl:pb-[10vh] h-full mt-5 sm:mt-0">
        <div
          id="main-txt"
        ...
        >
          <div className=" mb-6">
            ...
            <p className="animate-slide-in-left animation-delay-300 text-white font-grotesc-bold text-[3.5rem] sm:text-[4rem] md:text-[4.5rem] lg:text-[5rem] leading-[120%] ">
        ...
        <div className="flex flex-row items-center gap-8 w-[19rem] mt-8">
          <div className="flex flex-col justify-center">
            <p className="text-white font-grotesc-bold leading-[100%] lg:leading-[130%] text-3xl sm:text-4xl md:text-4xl lg:text-4xl">
      ...
      <div className="hidden absolute right-5 top-[40%] -translate-y-[50%] 2xl:flex">
        <img
          src={truck}
          alt="err"
          className={`h-[42rem] w-[41rem] ${isTruckVisible ? 'animate-slide-in-right' : 'animate-slide-out-right'}`}
        />
      </div>
    </Section>
  );
