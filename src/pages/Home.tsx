...
const Home = () => {
  return (
    <div
      className={`[clip-path:polygon(0_0,_100%_0,_100%_60%,_0%_100%)] bg-[#121D50] h-screen max-h-[950px] max-w-[1854px] mx-auto relative px-[9rem] pt-0.5 `}
    >
      {/* <div className="w-[65rem] h-full bg-amber-900 flex flex-col items-center justify-center mt-22"> */}
      <div className="w-[65rem] h-[35rem] flex flex-col mt-40">
        ...
        <img
          src={truck}
          alt="err"
          className="absolute right-0 top-20 h-[35rem] w-[34rem] "
        />
      </div>
    </div>
    // </div>
