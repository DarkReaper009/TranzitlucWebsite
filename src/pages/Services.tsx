...
const Services = () => {
  return (
    <div className="flex flex-col items-center h-[70rem] w-full  bg-gr1">
      <div className="flex flex-col items-center h-[70rem] w-full  px-[9rem] py-[6.9rem]  gap-16 max-w-[1854px] mx-auto">
